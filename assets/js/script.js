...
async function getAboutGitHub() {
  try {
    const resposta = await fetch("https://api.github.com/users/Marcsfic98");
...
async function getProjectsGitHub() {
  try {
    const resposta = await fetch(
      "https://api.github.com/users/Marcsfic98/repos?sort=updated&per_page=6"
    );
          ...
          <article class="project-card">
            ...
            <div class="project-content">
              ...
              <div class="project-buttons">
                <a href="${
                  repository.html_url
                }" target="_blank" class="button button-sm">GitHub</a>
                ${
                  repository.homepage
                    ? `<a href="${repository.homepage}" target="_blank" class="button-outline button-sm">Deploy</a>`
                    : ""
                }
              </div>
            </div>
